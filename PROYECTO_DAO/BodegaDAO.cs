...
namespace PROYECTO_DAO
{
    public class BodegaDAO
    {
        public Boolean Agregar(Bodega oBodega)
        {
            ...
            oCommand.CommandText = "PCKBODEGA.paInsertar";
        ...
        {
            OracleCommand oCommand = new OracleCommand();
            oCommand.CommandText = "PCKBODEGA.paEliminar";
            oCommand.CommandType = CommandType.StoredProcedure;
        ...
        {
            String sql = "Update TBL_BODEGA b set alm_descripcion = '" + oBodega.Descripcion + "', alm_actividad = '" + actividad + "', alm_cliente = '" + oBodega.Cliente + "' where no_cia = '" + oBodega.No_cia + "' and b.centro = '" + oBodega.Centro + "' and alm_id = '" + oBodega.Id + "' and alm_indice = '" + oBodega.Indice + "'";
        ...
        {
            String sql = "SELECT ALM_ID, ALM_DESCRIPCION, ALM_INDICE,alm_tipo FROM TBL_BODEGA b where no_cia = '" + pNo_cia + "' and b.centro = '" + pCentro + "' and ";
        ...
        {
            String sql = "SELECT ALM_ID, ALM_descripcion, alm_indice, alm_tipo FROM TBL_BODEGA b where no_cia = '" + pNo_cia + "' and b.centro = '" + pCentro + "' and ALM_ESTADO = 1 and ";
            if (tipo == 1)
        ...
        {
            String sql = "SELECT ALM_DESCRIPCION, alm_tipo FROM TBL_BODEGA b where no_cia = '" + pNo_cia + "' and b.centro = '" + pCentro + "' and ALM_ID = '" + cod + "' AND ALM_ESTADO=1";
        ...
        {
            String sql = "SELECT ALM_ID as cod, ALM_DESCRIPCION as descripcion FROM TBL_BODEGA b where no_cia = '" + pNo_cia + "' and b.centro = '" + pCentro + "' and  ALM_ESTADO = 1 and ALM_TIPO='" + tipo + "'";
            DataSet oDataSet = OracleDAO.getInstance().EjecutarSQLDataSet(sql);
            return oDataSet;
        }
        ...
        {
            String sql = "SELECT ALM_ID as cod, ALM_DESCRIPCION as descripcion FROM TBL_BODEGA b,TBL_ARTICULO_BODEGA aa where b.no_cia = '" + pNo_cia + "' and b.no_cia = aa.no_Cia and b.centro = '" + pCentro + "' and ARTALM_CODIGO='" + articulo + "' and ARTALM_PROVEEDOR='" + proveedor + "' and ALM_ESTADO = 1 and ARTALM_ALMACEN=ALM_ID";
            DataSet oDataSet = OracleDAO.getInstance().EjecutarSQLDataSet(sql);
            return oDataSet;
        }
        ...
        {
            String sql = "SELECT ALM_ID as cod, ALM_DESCRIPCION as descripcion FROM TBL_BODEGA b where no_cia = '" + pNo_cia + "' and b.centro = '" + pCentro + "' and ALM_ESTADO IN (1,2) order by alm_cliente desc,ALM_DESCRIPCION";
            DataSet oDataSet = OracleDAO.getInstance().EjecutarSQLDataSet(sql);
            return oDataSet;
        }
        ...
        {
            String sql = "SELECT ALM_ID as cod, ALM_DESCRIPCION as descripcion FROM TBL_BODEGA b where no_cia = '" + pNo_cia + "' and b.centro = '" + pCentro + "' and ALM_ESTADO IN (1,2) and ";
            if (tipo == 1)
        ...
        {
            String sql = "SELECT ALM_ID as cod, ALM_DESCRIPCION as descripcion FROM TBL_BODEGA b, TBL_ARTICULO_BODEGA aa where b.no_cia = '" + pNo_cia + "' b.no_cia = aa.no_cia and b.centro = '" + pCentro + "' and ARTALM_CODIGO='" + articulo + "' and ARTALM_PROVEEDOR='" + proveedor + "' and ALM_ESTADO = 1 and ARTALM_ALMACEN=ALM_ID and ";
            if (tipo == 1)
                sql += " regexp_like(ALM_ID,'" + palabra + "','i') order by ALm_descripcion";
            if (tipo == 2)
                sql += " regexp_like(ALM_descripcion,'" + palabra + "','i') order by ALm_descripcion";
        ...
        {
            String sql = "SELECT ALM_ID as cod, ALM_DESCRIPCION as descripcion FROM TBL_BODEGA b where no_cia = '" + pNo_cia + "' and b.centro = '" + pCentro + "' and ALM_ESTADO = 1 and ALM_TIPO='" + tipoAlmacen + "' and";
            if (tipo == 1)
                sql += " regexp_like(ALM_ID,'" + palabra + "','i') order by ALm_descripcion";
            if (tipo == 2)
                sql += " regexp_like(ALM_descripcion,'" + palabra + "','i') order by ALm_descripcion";
